...
/*
Enter the takeoff speed of the jet in km/hr: 278
Enter the distance over which the jet accelerates (meters): 94
The acceleration of the jet is: 11.86 m/s²
The time taken to reach the takeoff speed is: 23.43 seconds
